...
def create_transparent_overlay(thumbnail_path, output_path):
    try:
        ...
        resized_thumbnail = thumbnail_img.resize((864, 486))

        transparent_img = Image.new("RGBA", (1080, 1920), (0, 0, 0, 0))
        center_x = (1080 - 864) // 2
        center_y = (1920 - 486) // 2

        transparent_img.paste(resized_thumbnail, (center_x, center_y), resized_thumbnail)
